  ...
  const renderTokenSection = () => {
    ...
    if (account ) {
      if (publicIfoData.status === 'finished') {
        return <Text textAlign="center">{t('Get LC-BNB LP take part in next IFO‘s!')}</Text>
      }
      return <Text textAlign="center">{t('You need an LC-BNB LP to take part in an IFO!')}</Text>
    }
