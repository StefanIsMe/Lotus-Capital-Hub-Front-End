...
const Mint: React.FC = () => {
  ...
  return (
    <>
      ...
      <Text as="p" mb="24px">
        {t('You can change your profile pic later if you get another approved Lotus Capital Collectible.')}
      </Text>
      <Card mb="24px">
        <CardBody>
          ...
          {!hasMinimumCakeRequired && (
            <Text color="failure" mb="16px">
              {t('A minimum of %num% LC is required', { num: MINT_COST })}
            </Text>
          )}
