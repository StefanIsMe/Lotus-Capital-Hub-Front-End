  ...
  return (
    <Modal title={t('Claim your Gift!')} onDismiss={onDismiss}>
      <div style={{ maxWidth: '640px' }}>
        <Text as="p">{t('Thank you for being a day-one user of Lotus Capital Profiles!')}</Text>
        <Text as="p" mb="8px">
          {t(
        ...
        <Text as="p">{t('To make it up to you, we’ll refund you the full 4 LC it cost to make your bunny.')}</Text>
        <Text as="p" mb="8px">
