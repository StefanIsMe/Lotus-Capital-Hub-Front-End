  ...
  return (
    <>
      <Heading as="h4" scale="md" mb="8px">
        {t('Lotus Capital Collectibles')}
      </Heading>
      <Text as="p">
        {t('Lotus Capital Collectibles are special ERC-721 NFTs that can be used on the Lotus Capital platform.')}
      </Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved Lotus Capital Collectibles won’t be shown here.')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{t('See all approved Lotus Capital Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
