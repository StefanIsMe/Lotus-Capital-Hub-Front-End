    ...
    <Flex flexDirection="column" maxWidth="736px">
      ...
      <HowToCard number={1} title={t('Get Ready')}>
        <Text fontSize="14px" color="textSubtle">
          {t('Set up your')} <StyledLink href="/profile">{t('Lotus Capital Profile')}</StyledLink>
          {', '}
      ...
      <HowToCard number={2} title={t('Battle Time')}>
        <Text fontSize="14px" color="textSubtle">
          {t(
            'Trade BNB/BUSD, LC/BNB, ETH/BNB and BTCB/BNB during the battle period to raise both your and your team’s score. See the Rules section below for more.',
          )}
        </Text>
      </HowToCard>
