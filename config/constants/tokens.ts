...
export const LC: { [chainId: number]: Token } = {
...
const tokens = {
  ...
  cake: {
    ...
    decimals: 18,
    projectLink: 'https://lotuscapital.netlify.app/',
  },
  wbnb: {
    symbol: 'wBNB',
    address: {
  ...
  yukla: {
    symbol: '$YUKLA',
    address: {
      56: '0x2f392BBd06428Fd5dea8d7bC845C043040d8e2F8',
      96: '',
    },
    decimals: 18,
    projectLink: 'https://yuklaswap.finance',
  },
  eth: {
    symbol: 'ETH',
    address: {
  ...
  syrup: {
    symbol: 'LCRT',
    address: {
      56: '0x469CBc368913a3b9Ce29e289965D8b11B427DdEa',
