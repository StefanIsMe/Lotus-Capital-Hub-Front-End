...
// LC/Block in src/views/Home/components/CakeDataRow.tsx = 19 (40 - Amount sent to burn pool)
export const LC_PER_BLOCK = new BigNumber(13.5)
export const BLOCKS_PER_YEAR = new BigNumber((60 / BSC_BLOCK_TIME) * 60 * 24 * 365) // 10512000
export const LC_PER_YEAR = LC_PER_BLOCK.times(BLOCKS_PER_YEAR)
export const BASE_URL = 'https://lotuscapital.netlify.app'
